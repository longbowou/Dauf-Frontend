...
class SearchComponent {
    ...
    public showSuggestionsElement = () => {
        this.suggestionsElement.classList.remove("d-none");
    };

    public hideSuggestionsElement = () => {
        this.suggestionsElement.classList.add("d-none");
    };

    public showResultsElement = () => {
        this.resultsElement.classList.remove("d-none");
    };

    public hideResultsElement = () => {
        this.resultsElement.classList.add("d-none");
    };

    public showEmptyElement = () => {
        this.emptyElement.classList.remove("d-none");
    };

    public hideEmptyElement = () => {
